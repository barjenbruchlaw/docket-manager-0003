...
<Navbar className='Sidebar' variant='dark' collapseOnSelect expand="lg">
  ...
  <Navbar.Collapse id="responsive-navbar-nav">
    <Nav className='flex-column mt-5'>
      <Nav.Link className='SidebarItem mt-5' as={Link} to="/"><Geo /> Dashboard</Nav.Link>
      <Nav.Link className='SidebarItem' as={Link} to="/search"><Compass /> Search for a case</Nav.Link>
